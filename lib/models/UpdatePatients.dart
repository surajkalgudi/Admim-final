...
class UpdatePatients extends Model {
  ...
  const UpdatePatients._internal({required this.id, Uhid, Date, BloodPressure, HbPercentage, Sp02, Fbs, Ppbs, Height, Weight, Bmi, TrunkFat, HbA1c, TotalSkeletalMuscle, TrunkSkeletalMuscle, LegsSkeletalMuscle, TotalFat, LeftHandSP, RightHandSP, LeftLegSP, HandsSkeletal, LegsFat, MidArm, TricepsSkinFold, CalfSkinCircumference, HandsFat, RightLegSP, LeftLegEndurance, RightLegEndurance, RightHandEndurance, Waist, RbcCount, CalfCircumference, Neutrophil, LeftHandEndurance, Lymphocyte, Basophil, Monocyte, HctPcv, Hip, Albumin, WbcCount, Eosinophil, Urea, TotalCholesterol, LdlCholesterol, HdlCholesterol, Globulin, Triglyceride, DischargeDate, VldlCholesterol, Creatinine, createdAt, updatedAt}): _Uhid = Uhid, _Date = Date, _BloodPressure = BloodPressure, _HbPercentage = HbPercentage, _Sp02 = Sp02, _Fbs = Fbs, _Ppbs = Ppbs, _Height = Height, _Weight = Weight, _Bmi = Bmi, _TrunkFat = TrunkFat, _HbA1c = HbA1c, _TotalSkeletalMuscle = TotalSkeletalMuscle, _TrunkSkeletalMuscle = TrunkSkeletalMuscle, _LegsSkeletalMuscle = LegsSkeletalMuscle, _TotalFat = TotalFat, _LeftHandSP = LeftHandSP, _RightHandSP = RightHandSP, _LeftLegSP = LeftLegSP, _HandsSkeletal = HandsSkeletal, _LegsFat = LegsFat, _MidArm = MidArm, _TricepsSkinFold = TricepsSkinFold, _CalfSkinCircumference = CalfSkinCircumference, _HandsFat = HandsFat, _RightLegSP = RightLegSP, _LeftLegEndurance = LeftLegEndurance, _RightLegEndurance = RightLegEndurance, _RightHandEndurance = RightHandEndurance, _Waist = Waist, _RbcCount = RbcCount, _CalfCircumference = CalfCircumference, _Neutrophil = Neutrophil, _LeftHandEndurance = LeftHandEndurance, _Lymphocyte = Lymphocyte, _Basophil = Basophil, _Monocyte = Monocyte, _HctPcv = HctPcv, _Hip = Hip, _Albumin = Albumin, _WbcCount = WbcCount, _Eosinophil = Eosinophil, _Urea = Urea, _TotalCholesterol = TotalCholesterol, _LdlCholesterol = LdlCholesterol, _HdlCholesterol = HdlCholesterol, _Globulin = Globulin, _Triglyceride = Triglyceride, _DischargeDate = DischargeDate, _VldlCholesterol = VldlCholesterol, _Creatinine = Creatinine, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory UpdatePatients({String? id, int? Uhid, String? Date, String? BloodPressure, String? HbPercentage, String? Sp02, String? Fbs, String? Ppbs, double? Height, double? Weight, double? Bmi, String? TrunkFat, String? HbA1c, String? TotalSkeletalMuscle, String? TrunkSkeletalMuscle, String? LegsSkeletalMuscle, String? TotalFat, String? LeftHandSP, String? RightHandSP, String? LeftLegSP, String? HandsSkeletal, String? LegsFat, String? MidArm, String? TricepsSkinFold, String? CalfSkinCircumference, String? HandsFat, String? RightLegSP, String? LeftLegEndurance, String? RightLegEndurance, String? RightHandEndurance, String? Waist, String? RbcCount, String? CalfCircumference, String? Neutrophil, String? LeftHandEndurance, String? Lymphocyte, String? Basophil, String? Monocyte, String? HctPcv, String? Hip, String? Albumin, String? WbcCount, String? Eosinophil, String? Urea, String? TotalCholesterol, String? LdlCholesterol, String? HdlCholesterol, String? Globulin, String? Triglyceride, String? DischargeDate, String? VldlCholesterol, String? Creatinine, required Name}) {
  ...
  UpdatePatients copyWith({int? Uhid, String? Date, String? BloodPressure, String? HbPercentage, String? Sp02, String? Fbs, String? Ppbs, double? Height, double? Weight, double? Bmi, String? TrunkFat, String? HbA1c, String? TotalSkeletalMuscle, String? TrunkSkeletalMuscle, String? LegsSkeletalMuscle, String? TotalFat, String? LeftHandSP, String? RightHandSP, String? LeftLegSP, String? HandsSkeletal, String? LegsFat, String? MidArm, String? TricepsSkinFold, String? CalfSkinCircumference, String? HandsFat, String? RightLegSP, String? LeftLegEndurance, String? RightLegEndurance, String? RightHandEndurance, String? Waist, String? RbcCount, String? CalfCircumference, String? Neutrophil, String? LeftHandEndurance, String? Lymphocyte, String? Basophil, String? Monocyte, String? HctPcv, String? Hip, String? Albumin, String? WbcCount, String? Eosinophil, String? Urea, String? TotalCholesterol, String? LdlCholesterol, String? HdlCholesterol, String? Globulin, String? Triglyceride, String? DischargeDate, String? VldlCholesterol, String? Creatinine}) {
    return UpdatePatients._internal(
      id: id,
      Uhid: Uhid ?? this.Uhid,
      Date: Date ?? this.Date,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'Uhid': _Uhid, 'Date': _Date, 'BloodPressure': _BloodPressure, 'HbPercentage': _HbPercentage, 'Sp02': _Sp02, 'Fbs': _Fbs, 'Ppbs': _Ppbs, 'Height': _Height, 'Weight': _Weight, 'Bmi': _Bmi, 'TrunkFat': _TrunkFat, 'HbA1c': _HbA1c, 'TotalSkeletalMuscle': _TotalSkeletalMuscle, 'TrunkSkeletalMuscle': _TrunkSkeletalMuscle, 'LegsSkeletalMuscle': _LegsSkeletalMuscle, 'TotalFat': _TotalFat, 'LeftHandSP': _LeftHandSP, 'RightHandSP': _RightHandSP, 'LeftLegSP': _LeftLegSP, 'HandsSkeletal': _HandsSkeletal, 'LegsFat': _LegsFat, 'MidArm': _MidArm, 'TricepsSkinFold': _TricepsSkinFold, 'CalfSkinCircumference': _CalfSkinCircumference, 'HandsFat': _HandsFat, 'RightLegSP': _RightLegSP, 'LeftLegEndurance': _LeftLegEndurance, 'RightLegEndurance': _RightLegEndurance, 'RightHandEndurance': _RightHandEndurance, 'Waist': _Waist, 'RbcCount': _RbcCount, 'CalfCircumference': _CalfCircumference, 'Neutrophil': _Neutrophil, 'LeftHandEndurance': _LeftHandEndurance, 'Lymphocyte': _Lymphocyte, 'Basophil': _Basophil, 'Monocyte': _Monocyte, 'HctPcv': _HctPcv, 'Hip': _Hip, 'Albumin': _Albumin, 'WbcCount': _WbcCount, 'Eosinophil': _Eosinophil, 'Urea': _Urea, 'TotalCholesterol': _TotalCholesterol, 'LdlCholesterol': _LdlCholesterol, 'HdlCholesterol': _HdlCholesterol, 'Globulin': _Globulin, 'Triglyceride': _Triglyceride, 'DischargeDate': _DischargeDate, 'VldlCholesterol': _VldlCholesterol, 'Creatinine': _Creatinine, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'Uhid': _Uhid, 'Date': _Date, 'BloodPressure': _BloodPressure, 'HbPercentage': _HbPercentage, 'Sp02': _Sp02, 'Fbs': _Fbs, 'Ppbs': _Ppbs, 'Height': _Height, 'Weight': _Weight, 'Bmi': _Bmi, 'TrunkFat': _TrunkFat, 'HbA1c': _HbA1c, 'TotalSkeletalMuscle': _TotalSkeletalMuscle, 'TrunkSkeletalMuscle': _TrunkSkeletalMuscle, 'LegsSkeletalMuscle': _LegsSkeletalMuscle, 'TotalFat': _TotalFat, 'LeftHandSP': _LeftHandSP, 'RightHandSP': _RightHandSP, 'LeftLegSP': _LeftLegSP, 'HandsSkeletal': _HandsSkeletal, 'LegsFat': _LegsFat, 'MidArm': _MidArm, 'TricepsSkinFold': _TricepsSkinFold, 'CalfSkinCircumference': _CalfSkinCircumference, 'HandsFat': _HandsFat, 'RightLegSP': _RightLegSP, 'LeftLegEndurance': _LeftLegEndurance, 'RightLegEndurance': _RightLegEndurance, 'RightHandEndurance': _RightHandEndurance, 'Waist': _Waist, 'RbcCount': _RbcCount, 'CalfCircumference': _CalfCircumference, 'Neutrophil': _Neutrophil, 'LeftHandEndurance': _LeftHandEndurance, 'Lymphocyte': _Lymphocyte, 'Basophil': _Basophil, 'Monocyte': _Monocyte, 'HctPcv': _HctPcv, 'Hip': _Hip, 'Albumin': _Albumin, 'WbcCount': _WbcCount, 'Eosinophil': _Eosinophil, 'Urea': _Urea, 'TotalCholesterol': _TotalCholesterol, 'LdlCholesterol': _LdlCholesterol, 'HdlCholesterol': _HdlCholesterol, 'Globulin': _Globulin, 'Triglyceride': _Triglyceride, 'DischargeDate': _DischargeDate, 'VldlCholesterol': _VldlCholesterol, 'Creatinine': _Creatinine, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
