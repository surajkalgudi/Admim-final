...
class CreatePatients extends Model {
  ...
  factory CreatePatients({String? id, String? Name, int? Age, String? MaritalStatus, int? Children, String? Gender, String? Hospital, String? Doctor, int? Uhid, int? PhoneNumber, String? CancerType, String? Stage, String? TreatmentPlan, String? Comorbidities, String? History, String? SocialHistory, String? FamilyHistory, String? Address}) {
  ...
  CreatePatients copyWith({String? Name, int? Age, String? MaritalStatus, int? Children, String? Gender, String? Hospital, String? Doctor, int? Uhid, int? PhoneNumber, String? CancerType, String? Stage, String? TreatmentPlan, String? Comorbidities, String? History, String? SocialHistory, String? FamilyHistory, String? Address}) {
    return CreatePatients._internal(
      id: id,
      Name: Name ?? this.Name,
      Age: Age ?? this.Age,
